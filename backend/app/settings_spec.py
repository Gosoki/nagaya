...
SETTINGS_SPEC: dict[str, dict[str, Any]] = {
    "period_start_day": {
        ...
        "min": 1,
        "max": 31,
        "note_zh": "账期起算日。1＝自然月。设成 25 则「2026-09 期」＝ 8/25〜9/24。"
                   "改了只影响未来账期，已关账的不动。撞上短月自动取该月最后一天。",
        "note_ja": "会計期間の開始日。1＝暦月。25 にすると「2026-09 期」＝8/25〜9/24。"
                   "変更は未来の期間のみに適用。短い月は自動的に月末日になります。",
    },
    "settle_due_day": {
        "type": "int_or_null",
        "default": None,
        "min": 1,
        "max": 31,
        "note_zh": "结算日：次月几号之前结清。**只用于账单上那句话**，不参与归期。"
                   "留空则账单只写「未结清」，不写日期。",
        "note_ja": "精算日：翌月何日までに清算するか。**請求書の文言だけ**に使い、期間の判定には関与しません。"
                   "空欄なら「未精算」とだけ表示します。",
    },
    "default_payer_id": {
