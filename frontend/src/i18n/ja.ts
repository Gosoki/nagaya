export default {
  ...
  bill: {
    ...
    transferChanged: '金額がたった今変わりました（送金または新しい記帳があったため）。今回は記録していません。残りは {left} です。確認してからもう一度押してください',
    transferDoneElsewhere: 'この組み合わせは現在送金不要です（送金済み、またはプランが変わりました）。今回は記録していません。新しいプランを確認してください',
  ...
  errors: {
    ...
    transfer_changed: '送金額がたった今変わったため記録していません。更新して確認してください',
