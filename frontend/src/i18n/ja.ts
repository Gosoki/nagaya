export default {
  ...
  monthly: {
    carryFailed: '次の項目は今回自動で記帳していません（立替者が退去した、または新しい入居者がいて分担を決め直す必要があります）：{list} —— 下の行に金額を入力し、展開すると分担を変更できます',
    icon: 'アイコン', color: '色',
    settingsTitle: '固定費の項目',
    carried: '前期の金額で記帳しました：{list}',
    carryReady: '前期と同じ：{list}',
    carryDo: '前期の金額で記帳',
    carryBlocked: '{list} は「前期と同じ」がオンですが、今回はそのまま写せません（立替者が退去した、または新しい入居者がいます）—— 下の行に金額を入力し、展開すると分担を変更できます',
    sameAsLast: '前期と同じ',
    title: '今期の固定費',
    unsaved: '{n} 件未保存',
    saving: '保存中…',
  ...
  profile: {
    title: 'プロフィール',
    photo: 'アイコン', pickPhoto: '写真を選ぶ', removePhoto: '色に戻す', photoHint: 'タップして写真を変更',
  ...
  members: {
    ...
    joinedOn: '入居日',
    create: '追加',
    added: '追加しました。ログイン名「{login}」と初期パスワードを {name} さんに伝えて、ログイン後に「個人」でパスワードを変えてもらってください。',
  },
  appearance: {
    title: 'アプリ設定',
