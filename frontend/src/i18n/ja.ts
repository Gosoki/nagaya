export default {
  ...
  bill: {
    ...
    transferChanged: 'この送金はたった今ほかの人が記録済みです（二重には記録していません）。残りは {left}',
    transferDoneElsewhere: 'この送金はたった今ほかの人が記録済みで、もう送る必要はありません（二重には記録していません）',
  ...
  errors: {
    ...
    transfer_changed: 'この送金はたった今ほかの人が記録しました。更新して確認してください',
