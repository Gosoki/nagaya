...
import BackupCard from 'src/components/settings/BackupCard.vue'
import FixedCostSettings from 'src/components/settings/FixedCostSettings.vue'
import InstallCard from 'src/components/settings/InstallCard.vue'
import MembersCard from 'src/components/settings/MembersCard.vue'
import AppearanceCard from 'src/components/settings/AppearanceCard.vue'
import ProfileCard from 'src/components/settings/ProfileCard.vue'
